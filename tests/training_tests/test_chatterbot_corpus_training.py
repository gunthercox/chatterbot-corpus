...
class ChatterBotCorpusTrainingTestCase(ChatBotTestCase):
    ...
    def test_train_with_english_greeting_corpus(self):
        self.chatbot.train('corpus.data.english.greetings')
    ...
    def test_train_with_multiple_corpora(self):
        self.chatbot.train(
            'corpus.data.english.greetings',
            'corpus.data.english.conversations',
        )
    ...
    def test_train_with_english_corpus(self):
        self.chatbot.train('corpus.data.english')
        statement = self.chatbot.storage.find('Hello')
...
class ChatterBotCorpusFilePathTestCase(ChatBotTestCase):
    ...
    def setUp(self):
        ...
        self.corpus_directory = os.path.join(base_directory, 'corpus', 'data')
    ...
    def test_train_with_multiple_corpora(self):
        self.chatbot.train(
            'corpus/data/english/greetings.corpus.json',
